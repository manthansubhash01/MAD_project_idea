...
const CreateEventModal = ({ visible, onClose, onSave, initialEvent = null }) => {
  ...
  const handleSave = () => {
    ...
    if (!dateRegex.test(date)) {
      Alert.alert('Error', 'Date must be in format YYYY-MM-DD (e.g., 2025-11-10)');
      return;
    }
  ...
  const durations = ['30min', '1h', '1.5h', '2h', '2.5h', '3h', '4h', '5h', '6h'];
              ...
              <ScrollView horizontal style={styles.horizontalScroll} showsHorizontalScrollIndicator={false}>
                {hours.map((h) => (
                  <TouchableOpacity
                    ...
                    onPress={() => setHour(h)}
                  >
                    <Text style={[styles.chipText, hour === h && styles.chipTextSelected]}>
                      {h}
                    </Text>
                  </TouchableOpacity>
                ))}
